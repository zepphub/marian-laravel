...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-md-7 order-1 order-md-2">
                    <div
                        ...
                        <h5 class="my-3 text-primary">¡Quiero hacer el test!</h5>
    ...
    <section class="banner-home-1 d-flex align-items-center">
        <div class="container">
            <div class="row">
                <div class="col-md-8 offset-md-2">
                    <h4 class="epigrafe text-center mt-5">Acompaño profesionales y negocios digitales a crear una estrategia de marca
        ...
        <div class="container my-5">
            <div class="row">
                <div class="col-md-5 text-center text-md-left vcenter-col">
                    <img class="img-fluid" src="{{ asset('/img/about-me.jpg') }}" alt="">
                </div>
            ...
            <div class="col-md-4 mb-5">
                <div class="card border-secondary text-center card-propuestas shadow">
                    ...
                    <div class="card-body">
                        ...
                        <a href="https://servicios.marianpd.com/cursos" target="_blank" class="btn btn-primary">Ver los
                            cursos disponible</a>
                    </div>
                </div>
            </div>
    ...
    <!-- Seccion Newsletter -->
    <section id="newsletter-alma" class="bg-rosa-claro p-5 ">
        <div class="container my-5">
        <div class="row">
        ...
        <div class="row mt-3">
            <div class="col-md-8 offset-md-2 text-center">
                <form id="newsletterForm" class="needs-validation w-100" action="{{ route('newsletter-subscription') }}"
                    method="post">
                    @csrf
                    <x-honeypot />
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <input class="form-control  border-0" type="text" placeholder="Nombre" name="firstname"
                                required>
                        </div>
                        <div class="form-group col-md-6">
                            <input class="form-control  border-0" type="text" placeholder="Apellido" name="lastname"
                                required>
                        </div>
                    </div>
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            <input class="form-control  border-0" type="text" placeholder="Whatsapp" name="whatsapp"
                                required>
                        </div>
                    </div>
    ...
    <aside id="contacto" class="bg-crema-suave py-5">
                            ...
                            <ul class="list-group">
                                <li class="list-group-item border-0 bg-transparent p-0 pl-md-0 py-md-1">
                                    <div class="d-flex align-items-center">
                                        <svg class="mr-2 text-primary"
                                            xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                            fill="currentColor" class="bi bi-envelope" viewBox="0 0 16 16">
                                            <path
                                                d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1H2zm13 2.383-4.758 2.855L15 11.114v-5.73zm-.034 6.878L9.271 8.82 8 9.583 6.728 8.82l-5.694 3.44A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.739zM1 11.114l4.758-2.876L1 5.383v5.73z" />
                                        </svg> <a href="mailto:contacto@marianpd.com">contacto@marianpd.com</a></div>
                                </li>
