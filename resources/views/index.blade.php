                        ...
                        <g id="next_1_" data-name="next (1)" transform="translate(-60.433 -1.433)">
                            <g id="Grupo_475" data-name="Grupo 475" transform="translate(61 2)">
                                <path id="Trazado_343" data-name="Trazado 343"
                                    ...
                                    transform="translate(-117.742 0)" fill="currentColor" stroke="currentColor"
                                    stroke-width="1" />
                            </g>
                        </g>
                    </svg>
                            ...
                            <div class="list-group-item border-0 bg-transparent p-0">
                                <div class="btn-social-group d-flex align-items-center justify-content-center">
                                    <a class="" href="https://twitter.com/Marianaapd?s=08" target="_blank"><svg id="Componente_2_9" data-name="Componente 2 – 9"
                                            ...
                                            viewBox="0 0 42 42">
                                            <circle id="Elipse_1" data-name="Elipse 1" cx="21" cy="21" r="21"
                            ...
                            <div class="list-group-item border-0 bg-transparent p-0">
                                <div class="btn-social-group d-flex align-items-center justify-content-center">
                                    <a class="" href="https://www.instagram.com/mariann.pd/?hl=es-la" target="_blank"><svg id="Componente_4_15" data-name="Componente 4 – 15"
                                            xmlns="http://www.w3.org/2000/svg" width="42" height="42"
                                            viewBox="0 0 42 42">
                                            <circle id="Elipse_3" data-name="Elipse 3" cx="21" cy="21" r="21"
                                                fill="#f8337a" opacity="0" />
                                            <path id="instagram"
