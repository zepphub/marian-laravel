    ...
    <div class="container my-5">
      <div class="row">
        <div class="col-md-12 text-center">
          ...
          <h5 class=" text-marron-claro my-3">Seleccionar opción para comenzar</h5>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="tab-content" id="pills-tabContent">
            ...
            <div class="tab-pane fade text-center mt-4" id="pills-comenzar" role="tabpanel"
              ...
              <h5 class=" text-marron-claro my-3">Tengo la idea de proyecto pero, no estoy segura de cómo
              ...
              <div id="comenzar_resultado" class="row shadow rounded p-3 d-none">
                <div class="col-md-7 text-left">
                  <div class="p-md-4 p-0">
                    ...
                    <img src="{{ asset('img/separador-crema.svg') }}" class="separador-ondas" alt="">
                    ...
                    <p class=" text-marron-claro">Para que el contenido llegue a tu correo y para recibir recursos
                      ...
                      vemos allí!</p>
                    <a>
                      <h4 class="text-primary ">Descargar Guía <svg xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="tab-pane fade text-center mt-4" id="pills-mejorar" role="tabpanel"
              ...
              <h5 class=" text-marron-claro my-3">Mi proyecto está en marcha y necesito profesionalizar lo
