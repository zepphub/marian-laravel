    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <h1>Conferencias</h1>
                <h2>y Talleres a medida</h2>
                <nav class="" aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center bg-transparent text-marron-claro">
                        <li class="breadcrumb-item text-marron-claro"><a class="text-marron-claro"
                                href="{{ route('index') }}">Inicio</a></li>
                        <li class="breadcrumb-item text-secondary active font-weight-bold" aria-current="page">Talleres y Conferencias</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="container my-5">
        <div class="row">
            <div class="col-md-7 pl-md-5">
                ...
                <p>Al día de hoy llevo más de 8 años mentoreando proyectos y formando emprendedores y líderes de negocios
                    digitales, actividad que evolucionó junto a mi formación en Universidad EUDE (Escuela Europea de
                    Dirección y Empresa) siendo uno de los 10 mejores colegios de negocio de habla hispana, identificado por
                    el ranking FSO 2021 de Hamilton.
                    Entre ellas se encuentra una Maestría en Dirección de Negocios (MBA) y una Maestría en Marketing Digital
                    en curso.</p>

                <p>La experiencia me llevó a especializarme en la construcción de marca y en el desarrollo de estrategias
                ...
                <a href="#contacto" class="btn btn-primary mt-3">¡Quiero saber más! <svg class="ml-2"
