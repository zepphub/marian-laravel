...
@section('title')Programa Intensivo de Ocho Semanas | Eleva tu esencia - @endsection
            ...
            <form class="needs-validation form-home" novalidate>
              ...
              <div class="form-row">
                <div class="col-md-12 mb-3"> 
                  <textarea class="form-control" name="" id="" cols="30" rows="5" placeholder="Dejame tu consulta" required></textarea>
                </div>
              </div>
