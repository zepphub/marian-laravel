    ...
    <div class="container py-5">
      <div class="row">
        <div class="col-md-6">
          ...
          <h4 class="mt-5 font-weight-normal text-white">Construyamos el universo de tu marca y elevemos su posicionamiento en entornos digitales a través de dinámicas específicas, centradas en el marketing consciente y en la comunicación experiencial.</h4>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row mt-5">
      <div class="col-md-6 mb-5">
          <div class="card border-secondary text-center card-propuestas shadow">
              <img src="{{ asset('/img/card-mentoria-home.svg') }}" class="card-img-top w-25 mx-auto my-4 mb-2"
                  alt="...">
              <div class="card-body">
                  <h5 class="card-title titulo-home">Cursos <em>on demand</em></h5>
      ...
      <div class="col-md-6 mb-5">
          <div class="card border-secondary text-center card-propuestas shadow">
              <img src="{{ asset('/img/card-talleres-home.svg') }}" class="card-img-top w-25 mx-auto my-4 mb-2"
                  alt="...">
              <div class="card-body">
                  <h5 class="card-title titulo-home">MENTORÍA <em>personalizada</em></h5>
      ...
      <div class="col-md-6 mb-5">
        <div class="card border-secondary text-center card-propuestas shadow">
            ...
            <div class="card-body">
                <h5 class="card-title titulo-home">Conferencias y Talleres <em>a medida</em></h5>
