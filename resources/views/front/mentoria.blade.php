...
<header>
  ...
  <div id="mentoria-portada" class="d-flex align-items-center">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <h4 class="text-white ">Viajamos juntas al corazón de tu marca y aplicamos herramientas adaptadas
  ...
  <div id="mentoria-propuestas">
    <div class="container py-5">
      <div class="row">
        <div class="col-md-12">
          <h4 class="text-secondary  mb-3">Mis propuestas de mentoría para vos</h4>
            ...
            <div class="col-md-6">
              <div class="card border-secondary text-center card-propuestas shadow">
                ...
                <div class="card-body">
                  ...
                  <h5 class="card-title ">Eleva tu Marca Online</h5>
            ...
            <div class="col-md-6">
              <div class="card border-secondary text-center card-propuestas shadow">
                ...
                <div class="card-body">
                  ...
                  <h5 class="card-title ">Programa Selecto para Profesionales y Marcas Digitales</h5>
