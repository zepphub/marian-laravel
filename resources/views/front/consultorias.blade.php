  ...
  <div class="container my-5">
    ...
    <div class="row mt-5">
      <div class="col-md-12">
        ...
        @foreach ($counselings as $counseling)
          <div class="tab-pane fade @if ($loop->first) show active @endif mt-5" id="pills-{{ $loop->iteration }}" role="tabpanel" aria-labelledby="pills-{{ $loop->iteration }}-tab">
            <div class="row">
              <div class="col-md-6">
                ...
                <ul class="list-unstyled">
                  ...
                  <li class="my-1"><svg xmlns="http://www.w3.org/2000/svg" width="20.574" height="20.574"
                      ...
                      <g transform="translate(-3.375 -3.375)">
                        <path  d="M21.028,13.161l-.87-.9a.187.187,0,0,0-.138-.059h0a.18.18,0,0,0-.138.059l-6.034,6.078-2.2-2.2a.191.191,0,0,0-.277,0l-.88.88a.2.2,0,0,0,0,.282l2.77,2.77a.876.876,0,0,0,.579.282.918.918,0,0,0,.574-.272h0l6.612-6.647A.211.211,0,0,0,21.028,13.161Z"
                          transform="translate(-2.094 -2.619)" fill="#e67161" />
                        <path  d="M13.662,4.76a8.9,8.9,0,1,1-6.3,2.606,8.843,8.843,0,0,1,6.3-2.606m0-1.385A10.287,10.287,0,1,0,23.949,13.662,10.286,10.286,0,0,0,13.662,3.375Z"
                          fill="#e67161" />
                      </g>
                    </svg>
                    {{ $description->content }}
