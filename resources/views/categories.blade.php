        ...
        <div class="col-9 col-md-6">
            <div>
                ...
                <input class="form-control form-control-lg rounded-pill" type="text"
                    placeholder="Nombre de categoría" name="name" id="name">
            </div>
        </div>
    ...
    <div class="row mt-4">
        <div class="col-8 col-md-9">
            <div class="d-flex align-items-center h-100">
                ...
                <h5 class="text-bold text-marron-claro m-0">{{ $value->name }}</h5>
            </div>
        </div>
        <div class="col-4 col-md-3 d-flex align-items-center">
            <div class="">
                ...
                <a class="ml-2" href="{{route('category.delete', $value->id) }}"><svg xmlns="http://www.w3.org/2000/svg" width="44.028"
