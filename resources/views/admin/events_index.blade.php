...
@section('content')
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="d-flex flex-row align-items-center justify-content-between">
                            ...
                            <a style="white-space: nowrap;" href="{{ route('admin.events.create') }}"><button class="btn btn-primary">Nuevo evento</button></a>
                        </div>
                    </div>
                </div>
    ...
    @endif
                ...
                <div class="row mt-4">
                    <div class="col-8 col-md-6">
                        <div class="d-flex align-items-center">
                            <img src="{{ asset($event->image) }}" width=75px height=75px alt="">
                            <h5 class="text-bold text-marron-claro ml-3 mb-0">{{$event->title}}</h5>
                        </div>
                    </div>
                    ...
                    <div class="col-4 col-md-3 d-flex align-items-center">
                        <div>
          <form class="d-inline-flex" action="{{ route('admin.events.edit', $event) }}" method="GET">
            @csrf
          ...
          <form class="ml-2 d-inline-flex" action="{{ route('admin.events.destroy', $event) }}" method="POST">
            @csrf
            @method('DELETE')
