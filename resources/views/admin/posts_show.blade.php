            ...
            <div class="row">
                <div class="col-md-12 text-center d-flex flex-column align-items-center">
                    ...
                    <div class="align-items-center d-flex justify-content-around mt-4">
                        <h6 class="mr-3"><svg xmlns="http://www.w3.org/2000/svg" width="12.469" height="11.579"
                                viewBox="0 0 12.469 11.579">
                            ...
                            {{ $post->author }}</h6>
                        <h6><svg id="Icon_ionic-ios-calendar" data-name="Icon ionic-ios-calendar"
                                xmlns="http://www.w3.org/2000/svg" width="12.064" height="11.136"
                                viewBox="0 0 12.064 11.136">
