    ...
    <div class="row my-4">
        <div class="col-md-12">
            <div class="d-flex flex-column flex-md-row justify-content-md-end justify-content-center">
                <button class="btn btn-outline-primary mb-4 mb-md-0 mr-md-4">Descargar registros<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cloud-download ml-3" viewBox="0 0 16 16">
